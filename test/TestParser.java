...
public class TestParser {
    private void parse(String input) throws ParserException, TypeError {
    ...
    private void parseWithTypeError(String input) {
        TypeError exception = assertThrows(TypeError.class, () -> {
            parse(input);
        });
    ...
    public void testArrayCreationError() {
        parseWithTypeError("a bool[] = array [2] of;");
